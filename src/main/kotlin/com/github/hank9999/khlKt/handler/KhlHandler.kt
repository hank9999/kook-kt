...
class KhlHandler(config: Config) {
    ...
    private val messageFuncHandlers: MutableMap<MessageTypes, MutableList<(msg: KhlMessage, cs: CoroutineScope) -> Unit>> = mutableMapOf()
    ...
    private val eventFuncHandlers: MutableMap<EventTypes, MutableList<(event: KhlEvent, cs: CoroutineScope) -> Unit>> = mutableMapOf()
    ...
    fun registerMessageFuncHandler(type: MessageTypes, func: (msg: KhlMessage, cs: CoroutineScope) -> Unit) {
    ...
    fun registerEventFuncHandler(type: EventTypes, func: (event: KhlEvent, cs: CoroutineScope) -> Unit) {
    ...
    fun registerFilterFuncHandler(type: FilterTypes, startWith: String, keyword: String, regex: String, ignoreCase: Boolean, func: (msg: KhlMessage, cs: CoroutineScope) -> Unit) {
        val data = when (type) {
    ...
    fun registerCommandFuncHandler(name: String, prefixes: Array<String>, aliases: Array<String>, ignoreCase: Boolean, func: (msg: KhlMessage, cs: CoroutineScope) -> Unit) {
        val startWith = mutableListOf<String>()
